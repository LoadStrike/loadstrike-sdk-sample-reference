...
func (reference CreateMethodReference) CreateEmptyRunnerExample() any {
    return loadstrike.Create()
}

// Create a runner and immediately attach the baseline GET scenario.
func (reference CreateMethodReference) CreateRunnerAndAddScenarioExample() any {
    return loadstrike.Create().AddScenario(createBaselineScenario())
}
