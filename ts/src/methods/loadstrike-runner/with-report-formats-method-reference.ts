...
export class WithReportFormatsMethodReference {
  /** Write both text and HTML report outputs. */
  static async WriteTextAndHtmlReportsExample(): Promise<unknown> {
  ...
  static async WriteMarkdownOnlyReportExample(): Promise<unknown> {
