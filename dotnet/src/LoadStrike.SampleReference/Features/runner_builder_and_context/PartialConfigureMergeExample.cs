...
namespace LoadStrike.SampleReference.Features.RunnerBuilderAndContext;

/// <summary>
/// /// This feature area focuses on creating runners, reusing built contexts, and merging partial configuration. ///
/// </summary>
public static class PartialConfigureMergeExample
{
    public static object Build()
    {
        ...
        var feature = LoadStrikeRunner
                                .Create()
                                .AddScenario(Scenario())
                                .Configure(c => c.WithTestSuite("orders-a"))
                                .Configure(c => c.WithTestName("orders-b"));
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("partial-configure-merge"))
