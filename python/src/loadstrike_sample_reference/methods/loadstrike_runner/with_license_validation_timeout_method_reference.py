...
class WithLicenseValidationTimeoutMethodReference:
    @staticmethod
    def apply_short_timeout_example() -> Any:
        """Apply a shorter timeout to the runner."""
        return base_runner().with_license_validation_timeout(5)

    @staticmethod
    def apply_long_timeout_example() -> Any:
        """Apply a longer timeout to the runner."""
        return base_runner().with_license_validation_timeout(15)
