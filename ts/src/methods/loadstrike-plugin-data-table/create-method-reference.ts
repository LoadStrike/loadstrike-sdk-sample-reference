...
export class CreateMethodReference {
  /** Create the plugin data or table object directly. */
  static async CreatePluginDataExample(): Promise<unknown> {
  ...
  static async AttachPluginDataExample(): Promise<unknown> {
      return new OrdersWorkerPlugin().getData(null as any);
  }
}
