...
class WithMinimumLogLevelMethodReference:
    @staticmethod
    def set_warning_level_example() -> Any:
        """Lower the logger to warning-level output."""
        return base_runner().with_minimum_log_level("Warning")

    @staticmethod
    def set_debug_level_example() -> Any:
        """Raise the logger detail for troubleshooting a sample run."""
        return base_runner().with_minimum_log_level("Debug")
