package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithWorkerPluginsMethodReference {
        private WithWorkerPluginsMethodReference() {}
...
public static Object AttachOneWorkerPluginExample() {
    return baseRunner().withWorkerPlugins(new OrdersWorkerPlugin());
}

/** Attach multiple worker plugins in one call. */
public static Object AttachTwoWorkerPluginsExample() {
    return baseRunner().withWorkerPlugins(new OrdersWorkerPlugin(), new OrdersWorkerPlugin());
}
      }
