using System;
    ...
    /// <summary>Set the scenario completion timeout.</summary>
    public static class WithScenarioCompletionTimeoutMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Apply a shorter timeout to the runner.</summary>
public static object? ApplyShortTimeoutExample()
{
    return LoadStrikeRunner.WithScenarioCompletionTimeout(baseContext(), TimeSpan.FromSeconds(5));
}

/// <summary>Apply a longer timeout to the runner.</summary>
public static object? ApplyLongTimeoutExample()
{
    return LoadStrikeRunner.WithScenarioCompletionTimeout(baseContext(), TimeSpan.FromSeconds(15));
}
    }
