...
class WithRunnerKeyMethodReference:
    @staticmethod
    def apply_primary_value_example() -> Any:
        """Apply the primary string value shown in the sample method reference."""
        return base_runner().with_runner_key("runner_dummy_orders_reference")

    @staticmethod
    def apply_alternate_value_example() -> Any:
        """Show the same method with a second concrete value."""
        return base_runner().with_runner_key("runner_dummy_checkout_reference")
