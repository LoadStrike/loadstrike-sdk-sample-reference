using System;
    ...
    /// <summary>Turn on local development cluster mode.</summary>
    public static class EnableLocalDevClusterMethodReference
    {
...
public static object? EnableOnExample()
{
    return LoadStrikeRunner.EnableLocalDevCluster(baseContext(), true);
}

/// <summary>Apply the boolean option in its disabled state.</summary>
public static object? EnableOffExample()
{
    return LoadStrikeRunner.EnableLocalDevCluster(baseContext(), false);
}
    }
