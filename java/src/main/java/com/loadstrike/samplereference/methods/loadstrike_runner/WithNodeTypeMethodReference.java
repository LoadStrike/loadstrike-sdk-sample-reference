package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithNodeTypeMethodReference {
        private WithNodeTypeMethodReference() {}
...
public static Object UseCoordinatorNodeExample() {
    return baseRunner().withNodeType("Coordinator");
}

/** Set the runner to agent mode. */
public static Object UseAgentNodeExample() {
    return baseRunner().withNodeType("Agent");
}
      }
