...
class WithReportingSinksMethodReference:
    @staticmethod
    def attach_one_sink_example() -> Any:
        """Attach one custom reporting sink instance."""
        return base_runner().with_reporting_sinks(OrdersReportingSink())

    @staticmethod
    def attach_two_sinks_example() -> Any:
        """Attach multiple sink instances in the same call."""
        return base_runner().with_reporting_sinks(OrdersReportingSink(), OrdersReportingSink())
