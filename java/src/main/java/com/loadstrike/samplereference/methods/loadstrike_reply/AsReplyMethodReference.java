package com.loadstrike.samplereference.methods.loadstrike_reply;
      ...
      public final class AsReplyMethodReference {
        private AsReplyMethodReference() {}
...
public static Object ProjectTypedReplyExample() {
    return LoadStrikeResponse.ok(Map.of("orderId", 42), "200", 128, "ok", 3.2).asReply();
}

/** Project a failed typed reply into the untyped reply contract. */
public static Object ProjectFailedTypedReplyExample() {
    return LoadStrikeResponse.fail(Map.of("error", "not-found"), "404", "missing", 64, 3.2d).asReply();
}
      }
