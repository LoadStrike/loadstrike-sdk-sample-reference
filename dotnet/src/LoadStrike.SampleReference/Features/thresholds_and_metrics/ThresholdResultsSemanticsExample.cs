...
/// </summary>
public static class ThresholdResultsSemanticsExample
{
    public static object Build()
    {
        ...
        var result = LoadStrikeRunner
            .RegisterScenarios(
                ScenarioWithThreshold(
                    "threshold-results",
                    LoadStrikeThreshold.CreateScenario(
                        stats => stats.AllOkCount >= 1,
                        1,
            ...
            .WithTestName("threshold-results")
            .WithoutReports()
            .Run();
        var feature = new { result.FailedThresholds };
