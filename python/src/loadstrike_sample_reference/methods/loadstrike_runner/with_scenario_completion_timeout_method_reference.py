...
class WithScenarioCompletionTimeoutMethodReference:
    @staticmethod
    def apply_short_timeout_example() -> Any:
        """Apply a shorter timeout to the runner."""
        return base_runner().with_scenario_completion_timeout(5)

    @staticmethod
    def apply_long_timeout_example() -> Any:
        """Apply a longer timeout to the runner."""
        return base_runner().with_scenario_completion_timeout(15)
