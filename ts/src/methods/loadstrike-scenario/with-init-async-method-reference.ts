...
export class WithInitAsyncMethodReference {
  ...
  static async AttachAsyncMetricHookExample(): Promise<unknown> {
      return baselineScenario().withInitAsync(async context => context.registerMetric(LoadStrikeMetric.counter("orders_seen", "count")));
  }
}
