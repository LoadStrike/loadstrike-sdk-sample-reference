using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerLoadStrikePluginDataTable;

    /// <summary>Create a plugin data table.</summary>
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Create the plugin data or table object directly.</summary>
public static object? CreatePluginDataExample()
{
    return LoadStrikePluginDataTable.Create("Orders");
}

/// <summary>Build on the created object to show how the method fits into the reporting surface.</summary>
public static object? AttachPluginDataExample()
{
    return new OrdersWorkerPlugin().GetData(default!);
}
    }
