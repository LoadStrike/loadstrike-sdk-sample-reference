package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithReportFormatsMethodReference {
        private WithReportFormatsMethodReference() {}
...
public static Object WriteTextAndHtmlReportsExample() {
    return baseRunner().withReportFormats(LoadStrikeReportFormat.Txt, LoadStrikeReportFormat.Html);
}

/** Switch to a single markdown-style report format. */
public static Object WriteMarkdownOnlyReportExample() {
    return baseRunner().withReportFormats(LoadStrikeReportFormat.Md);
}
      }
