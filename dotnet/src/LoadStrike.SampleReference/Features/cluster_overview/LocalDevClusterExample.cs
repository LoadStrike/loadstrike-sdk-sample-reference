...
/// </summary>
public static class LocalDevClusterExample
{
    public static object Build()
    {
        // Local Dev Cluster is the feature being explained. The sample returns that focused object alongside a minimal run result.
        var feature = ClusterRunner();
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("local-dev-cluster"))
            .WithRunnerKey(OrdersWorkflowPlaceholders.RunnerKey)
            .WithTestSuite("orders-reference")
            .WithTestName("local-dev-cluster")
            .WithoutReports()
            .Run();
