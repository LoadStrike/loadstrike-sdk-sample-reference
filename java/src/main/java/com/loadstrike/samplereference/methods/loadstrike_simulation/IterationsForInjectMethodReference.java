package com.loadstrike.samplereference.methods.loadstrike_simulation;
      ...
      public final class IterationsForInjectMethodReference {
        private IterationsForInjectMethodReference() {}
...
public static Object CreatePrimarySimulationExample() {
    return LoadStrikeSimulation.iterationsForInject(2, 0.25d, 5);
}

/** Attach the simulation to the baseline GET scenario. */
public static Object AttachSimulationToScenarioExample() {
    return baselineScenario().withLoadSimulations(LoadStrikeSimulation.iterationsForInject(2, 0.25d, 5));
}
      }
