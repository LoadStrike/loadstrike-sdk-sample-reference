using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerLoadStrikeScenarioInitContext;

    /// <summary>Register a metric during scenario init.</summary>
    public static class RegisterMetricMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Call the public context helper directly from the scenario context surface.</summary>
public static object? UseContextMethodExample()
{
    return Metric.CreateCounter("orders_total", "count");
}

/// <summary>Show the same helper in the baseline GET-step flow.</summary>
        public static object? UseContextMethodInStepExample()
        {
