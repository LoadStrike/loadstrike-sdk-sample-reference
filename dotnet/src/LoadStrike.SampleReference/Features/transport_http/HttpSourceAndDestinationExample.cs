...
/// </summary>
public static class HttpSourceAndDestinationExample
{
    public static object Build()
    {
        ...
        var endpoints = new { Source = HttpSource(), Destination = HttpDestination() };
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("http-source-and-destination"))
