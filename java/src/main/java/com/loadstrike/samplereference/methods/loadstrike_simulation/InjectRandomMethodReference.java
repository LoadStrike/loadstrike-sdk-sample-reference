package com.loadstrike.samplereference.methods.loadstrike_simulation;
      ...
      public final class InjectRandomMethodReference {
        private InjectRandomMethodReference() {}
...
public static Object CreatePrimarySimulationExample() {
    return LoadStrikeSimulation.injectRandom(2, 4, 0.25d, 20d);
}

/** Attach the simulation to the baseline GET scenario. */
public static Object AttachSimulationToScenarioExample() {
    return baselineScenario().withLoadSimulations(LoadStrikeSimulation.injectRandom(2, 4, 0.25d, 20d));
}
      }
