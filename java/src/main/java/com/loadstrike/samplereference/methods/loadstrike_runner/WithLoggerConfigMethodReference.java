package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithLoggerConfigMethodReference {
        private WithLoggerConfigMethodReference() {}
...
public static Object AttachInlineLoggerFactoryExample() {
    return baseRunner().withLoggerConfig(() -> new LoadStrikeLogger() {});
}

/** Attach the logger factory before building a reusable context. */
public static Object AttachLoggerBeforeContextBuildExample() {
    return baseRunner().withLoggerConfig(() -> new LoadStrikeLogger() {}).buildContext();
}
      }
