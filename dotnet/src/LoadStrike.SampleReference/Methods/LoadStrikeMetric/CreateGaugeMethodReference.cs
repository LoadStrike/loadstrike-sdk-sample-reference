using System;
    ...
    /// <summary>Create a gauge metric and register it during scenario init.</summary>
    public static class CreateGaugeMethodReference
    {
...
{
    return Metric.CreateGauge("orders_latency", "ms");
}
...
/// <summary>Register the metric during scenario init so the GET scenario can report it.</summary>
        ...
        {
            var metric = Metric.CreateGauge("orders_latency", "ms");
