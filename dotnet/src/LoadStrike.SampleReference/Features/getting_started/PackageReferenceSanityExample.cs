...
namespace LoadStrike.SampleReference.Features.GettingStarted;
...
/// </summary>
public static class PackageReferenceSanityExample
{
    public static object Build()
    {
        // Package Reference Sanity is the feature being explained. The sample returns that focused object alongside a minimal run result.
        var feature = Runner();
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("package-reference-sanity"))
            .WithRunnerKey(OrdersWorkflowPlaceholders.RunnerKey)
            .WithTestSuite("orders-reference")
            .WithTestName("package-reference-sanity")
            .WithoutReports()
            .Run();
