using System;
    ...
    /// <summary>Attach one or more reporting sinks.</summary>
    public static class WithReportingSinksMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Attach one custom reporting sink instance.</summary>
public static object? AttachOneSinkExample()
{
    return LoadStrikeRunner.WithReportingSinks(baseContext(), new OrdersReportingSink());
}

/// <summary>Attach multiple sink instances in the same call.</summary>
public static object? AttachTwoSinksExample()
{
    return LoadStrikeRunner.WithReportingSinks(baseContext(), new OrdersReportingSink(), new OrdersReportingSink());
}
    }
