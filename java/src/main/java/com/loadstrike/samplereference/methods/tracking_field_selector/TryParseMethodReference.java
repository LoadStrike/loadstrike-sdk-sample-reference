package com.loadstrike.samplereference.methods.tracking_field_selector;
      ...
      public final class TryParseMethodReference {
        private TryParseMethodReference() {}
...
public static Object CreateCorrelationExample() {
    return TrackingFieldSelector.tryParse("header:x-id");
}
