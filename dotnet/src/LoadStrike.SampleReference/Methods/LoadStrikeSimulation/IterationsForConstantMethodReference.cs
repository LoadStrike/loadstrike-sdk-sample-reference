using System;
    ...
    /// <summary>Run a fixed number of iterations at constant copies.</summary>
    public static class IterationsForConstantMethodReference
    {
...
{
    return LoadStrikeSimulation.IterationsForConstant(1, 3);
}
