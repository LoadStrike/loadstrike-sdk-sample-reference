using System;
    ...
    /// <summary>Ramp an injected request rate over time.</summary>
    public static class RampingInjectMethodReference
    {
...
{
    return LoadStrikeSimulation.RampingInject(5, TimeSpan.FromMilliseconds(250), TimeSpan.FromSeconds(20));
}

/// <summary>Attach the simulation to the baseline GET scenario.</summary>
public static object? AttachSimulationToScenarioExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.RampingInject(5, TimeSpan.FromMilliseconds(250), TimeSpan.FromSeconds(20)));
}
    }
