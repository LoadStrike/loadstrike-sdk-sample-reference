using System;
    ...
    /// <summary>Set the realtime reporting cadence.</summary>
    public static class WithReportingIntervalMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Set a faster realtime reporting cadence.</summary>
public static object? UseFastIntervalExample()
{
    return baseRunner().WithReportingInterval(TimeSpan.FromSeconds(1));
}

/// <summary>Set a slower reporting cadence for noisier runs.</summary>
public static object? UseSlowerIntervalExample()
{
    return baseRunner().WithReportingInterval(TimeSpan.FromSeconds(5));
}
    }
