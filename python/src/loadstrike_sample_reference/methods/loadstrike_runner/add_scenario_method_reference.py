...
class AddScenarioMethodReference:
    @staticmethod
    def add_one_scenario_example() -> Any:
        """Attach one scenario to a reusable runner."""
        return base_runner().add_scenario(baseline_scenario())

    @staticmethod
    def add_second_scenario_example() -> Any:
        """Attach a second scenario after the first GET scenario is already registered."""
        return base_runner().add_scenario(baseline_scenario()).add_scenario(baseline_scenario("orders.audit"))
