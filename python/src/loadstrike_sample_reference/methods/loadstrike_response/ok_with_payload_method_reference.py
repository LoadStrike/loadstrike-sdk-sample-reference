...
class OkWithPayloadMethodReference:
    @staticmethod
    def create_primary_reply_example() -> Any:
        """Create the primary reply shape for this helper."""
        return LoadStrikeResponse.ok_with_payload({"orderId": "ORD-10001"}, "202", 128, "accepted", 3.2)

    @staticmethod
    def create_alternate_reply_example() -> Any:
        """Create an alternate reply shape that changes status or message metadata."""
        return LoadStrikeResponse.ok_with_payload({"orderId": "ORD-10002"}, "201", 64, "created", 4.6)
