using System;
    ...
    /// <summary>Extract a tracking value from a response payload where exposed.</summary>
    public static class ExtractMethodReference
    {
...
{
    return TrackingFieldSelector.Parse("json:$.trackingId").Extract(buildTrackingPayload());
}
