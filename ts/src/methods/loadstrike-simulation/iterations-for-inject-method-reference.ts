...
export class IterationsForInjectMethodReference {
  /** Create the simulation shape named by this method reference. */
  static async CreatePrimarySimulationExample(): Promise<unknown> {
      return LoadStrikeSimulation.iterationsForInject(2, 0.25, 5);
  }

  /** Attach the simulation to the baseline GET scenario. */
  static async AttachSimulationToScenarioExample(): Promise<unknown> {
      return baselineScenario().withLoadSimulations(LoadStrikeSimulation.iterationsForInject(2, 0.25, 5));
  }
}
