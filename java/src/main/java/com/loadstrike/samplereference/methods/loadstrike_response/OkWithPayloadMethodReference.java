package com.loadstrike.samplereference.methods.loadstrike_response;
      ...
      public final class OkWithPayloadMethodReference {
        private OkWithPayloadMethodReference() {}
...
public static Object CreatePrimaryReplyExample() {
    return LoadStrikeResponse.okWithPayload(Map.of("orderId", "ORD-10001"), "202", 128, "accepted", 3.2d);
}

/** Create an alternate reply shape that changes status or message metadata. */
public static Object CreateAlternateReplyExample() {
    return LoadStrikeResponse.okWithPayload(Map.of("orderId", "ORD-10002"), "201", 64, "created", 4.6d);
}
      }
