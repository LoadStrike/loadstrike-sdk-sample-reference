package com.loadstrike.samplereference.methods.loadstrike_scenario;
      ...
      public final class WithCleanMethodReference {
        private WithCleanMethodReference() {}
...
public static Object AttachNoOpHookExample() {
    return baselineScenario().withClean(context -> null);
}
...
public static Object AttachMetricAwareHookExample() {
    return baselineScenario().withClean(context -> { context.registerMetric(LoadStrikeMetric.counter("orders_seen", "count")); return null; });
}
      }
