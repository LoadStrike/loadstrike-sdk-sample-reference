using System;
    ...
    /// <summary>Run a fixed number of iterations at an injected rate.</summary>
    public static class IterationsForInjectMethodReference
    {
...
{
    return LoadStrikeSimulation.IterationsForInject(2, TimeSpan.FromMilliseconds(250), 5);
}

/// <summary>Attach the simulation to the baseline GET scenario.</summary>
public static object? AttachSimulationToScenarioExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.IterationsForInject(2, TimeSpan.FromMilliseconds(250), 5));
}
    }
