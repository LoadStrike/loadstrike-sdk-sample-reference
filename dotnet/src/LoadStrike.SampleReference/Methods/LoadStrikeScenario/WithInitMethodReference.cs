using System;
    ...
    /// <summary>Attach a synchronous init hook.</summary>
    public static class WithInitMethodReference
    {
...
{
    return baselineScenario().WithInit(context => Task.CompletedTask);
}
...
{
    return baselineScenario().WithInit(context => { context.RegisterMetric(Metric.CreateCounter("orders_seen", "count")); return Task.CompletedTask; });
}
    }
