...
namespace LoadStrike.SampleReference.Features.ScenariosAndSteps;
...
/// </summary>
public static class AsyncLifecycleHooksExample
{
    public static object Build()
    {
        ...
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("async-lifecycle-hooks"))
