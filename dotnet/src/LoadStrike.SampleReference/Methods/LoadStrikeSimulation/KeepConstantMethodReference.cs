using System;
    ...
    /// <summary>Maintain a constant number of concurrent copies.</summary>
    public static class KeepConstantMethodReference
    {
...
{
    return LoadStrikeSimulation.KeepConstant(2, TimeSpan.FromSeconds(20));
}

/// <summary>Attach the simulation to the baseline GET scenario.</summary>
public static object? AttachSimulationToScenarioExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.KeepConstant(2, TimeSpan.FromSeconds(20)));
}
    }
