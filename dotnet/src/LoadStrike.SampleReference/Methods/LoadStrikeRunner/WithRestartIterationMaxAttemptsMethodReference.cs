using System;
    ...
    /// <summary>Control restart-on-fail retries.</summary>
    public static class WithRestartIterationMaxAttemptsMethodReference
    {
