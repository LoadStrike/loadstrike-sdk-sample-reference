using System;
    ...
    /// <summary>Disable local report generation.</summary>
    public static class WithoutReportsMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Disable local report writing for the baseline GET scenario.</summary>
public static object? DisableReportsExample()
{
    return baseRunner().WithoutReports();
}

/// <summary>Disable reports even after setting a report folder.</summary>
public static object? DisableReportsAfterReportFolderExample()
{
    return baseRunner().WithReportFolder("./artifacts/reports").WithoutReports();
}
    }
