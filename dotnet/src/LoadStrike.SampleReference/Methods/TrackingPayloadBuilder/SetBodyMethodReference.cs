using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerTrackingPayloadBuilder;

    /// <summary>Attach a body payload before building a tracking payload.</summary>
    public static class SetBodyMethodReference
    {
