...
FEATURE_OVERVIEW = "This feature area focuses on how clustered runs target scenarios and assign partitions without changing the sample scenario body."
...
def build():
    ...
    context = _runner().build_context().with_cluster_id("orders-cluster").with_agent_group("orders-agents").with_agents_count(3).with_coordinator_target_scenarios("orders.publish")
