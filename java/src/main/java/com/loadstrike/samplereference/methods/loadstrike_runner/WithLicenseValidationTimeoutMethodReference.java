package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithLicenseValidationTimeoutMethodReference {
        private WithLicenseValidationTimeoutMethodReference() {}
...
public static Object ApplyShortTimeoutExample() {
    return baseRunner().withLicenseValidationTimeout(5);
}

/** Apply a longer timeout to the runner. */
public static Object ApplyLongTimeoutExample() {
    return baseRunner().withLicenseValidationTimeout(15);
}
      }
