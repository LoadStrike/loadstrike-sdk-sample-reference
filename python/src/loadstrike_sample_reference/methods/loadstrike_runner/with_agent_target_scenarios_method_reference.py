...
class WithAgentTargetScenariosMethodReference:
    @staticmethod
    def select_one_scenario_example() -> Any:
        """Target a single scenario by name."""
        return base_runner().with_agent_target_scenarios("orders.get-by-id")

    @staticmethod
    def select_multiple_scenarios_example() -> Any:
        """Target more than one named scenario in the same call."""
        return base_runner().with_agent_target_scenarios("orders.get-by-id", "orders.audit")
