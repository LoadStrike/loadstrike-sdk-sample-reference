...
class WithMaxFailCountMethodReference:
    @staticmethod
    def stop_after_one_failure_example() -> Any:
        """Stop the scenario after the first failure."""
        return baseline_scenario().with_max_fail_count(1)

    @staticmethod
    def stop_after_three_failures_example() -> Any:
        """Allow a few failures before stopping the scenario."""
        return baseline_scenario().with_max_fail_count(3)
