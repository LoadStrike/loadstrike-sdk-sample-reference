...
/// </summary>
public static class HeaderAndJsonSelectorsExample
{
    public static object Build()
    {
        ...
        var selectors = new { Source = HttpSource(), Destination = HttpDestination() };
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("header-and-json-selectors"))
            .WithRunnerKey(OrdersWorkflowPlaceholders.RunnerKey)
            .WithTestSuite("orders-reference")
            .WithTestName("header-and-json-selectors")
            .WithoutReports()
            .Run();

        return new { selectors, Result = result };
    }
