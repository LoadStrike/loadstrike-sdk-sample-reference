...
class WithRestartIterationMaxAttemptsMethodReference:
    @staticmethod
    def apply_smaller_count_example() -> Any:
        """Apply the option with a smaller numeric value."""
        return base_runner().with_restart_iteration_max_attempts(2)

    @staticmethod
    def apply_larger_count_example() -> Any:
        """Apply the option with a larger numeric value."""
        return base_runner().with_restart_iteration_max_attempts(4)
