using System;
    ...
    /// <summary>Choose whether policy failures fail the run or continue.</summary>
    public static class WithRuntimePolicyErrorModeMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Continue when policy hooks fail.</summary>
public static object? ContinueOnPolicyErrorExample()
{
    return baseRunner().WithRuntimePolicyErrorMode(LoadStrikeRuntimePolicyErrorMode.Continue);
}

/// <summary>Fail the run when policy hooks fail.</summary>
public static object? FailOnPolicyErrorExample()
{
    return baseRunner().WithRuntimePolicyErrorMode(LoadStrikeRuntimePolicyErrorMode.Fail);
}
    }
