...
export async function build() {
  ...
  const feature = { scenario: scenario("named-steps"), stepHelper: publishStep };
  const result = await LoadStrikeRunner.registerScenarios(scenario("named-steps")).withRunnerKey(RUNNER_KEY).withTestSuite("orders-reference").withTestName("named-steps").withoutReports().run();
