using System;
    ...
    /// <summary>Register one or more scenarios in a single call.</summary>
    public static class RegisterScenariosMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Register one baseline GET scenario in a single call.</summary>
public static object? RegisterSingleScenarioExample()
{
    return LoadStrikeRunner.RegisterScenarios(baselineScenario());
}

/// <summary>Register multiple scenarios without switching back to the builder flow.</summary>
public static object? RegisterMultipleScenariosExample()
{
    return LoadStrikeRunner.RegisterScenarios(baselineScenario(), baselineScenario("orders.audit"));
}
    }
