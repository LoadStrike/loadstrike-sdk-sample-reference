using System;
    ...
    /// <summary>Create a scenario-level threshold.</summary>
    public static class CreateScenarioMethodReference
    {
...
{
    return LoadStrikeThreshold.CreateScenario(stats => stats.AllRequestCount >= 1, 1, TimeSpan.FromSeconds(2));
}
