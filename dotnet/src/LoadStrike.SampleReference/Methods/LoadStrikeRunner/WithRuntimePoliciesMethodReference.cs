using System;
    ...
    /// <summary>Attach runtime policies that observe scenario and step execution.</summary>
    public static class WithRuntimePoliciesMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Attach one runtime policy implementation.</summary>
public static object? AttachOnePolicyExample()
{
    return baseRunner().WithRuntimePolicies(new OrdersRuntimePolicy());
}

/// <summary>Attach multiple runtime policy instances.</summary>
public static object? AttachTwoPoliciesExample()
{
    return baseRunner().WithRuntimePolicies(new OrdersRuntimePolicy(), new OrdersRuntimePolicy());
}
    }
