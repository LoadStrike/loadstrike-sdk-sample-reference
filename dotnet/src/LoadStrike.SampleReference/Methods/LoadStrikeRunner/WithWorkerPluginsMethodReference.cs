using System;
    ...
    /// <summary>Attach worker plugins that contribute final report data.</summary>
    public static class WithWorkerPluginsMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Attach one worker plugin instance.</summary>
public static object? AttachOneWorkerPluginExample()
{
    return LoadStrikeRunner.WithWorkerPlugins(baseContext(), new OrdersWorkerPlugin());
}

/// <summary>Attach multiple worker plugins in one call.</summary>
public static object? AttachTwoWorkerPluginsExample()
{
    return LoadStrikeRunner.WithWorkerPlugins(baseContext(), new OrdersWorkerPlugin(), new OrdersWorkerPlugin());
}
    }
