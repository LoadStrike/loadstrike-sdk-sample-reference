...
class StopCurrentTestMethodReference:
    @staticmethod
    def use_context_method_example() -> Any:
        """Call the public context helper directly from the scenario context surface."""
        return LoadStrikeScenario.create("orders.stop-test", lambda context: (context.stop_current_test("stop-now"), LoadStrikeResponse.ok())[1])
