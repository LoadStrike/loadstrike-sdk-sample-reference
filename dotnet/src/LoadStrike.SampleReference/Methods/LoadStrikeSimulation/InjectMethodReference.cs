using System;
    ...
    /// <summary>Inject a fixed request rate.</summary>
    public static class InjectMethodReference
    {
...
{
    return LoadStrikeSimulation.Inject(4, TimeSpan.FromMilliseconds(250), TimeSpan.FromSeconds(20));
}

/// <summary>Attach the simulation to the baseline GET scenario.</summary>
public static object? AttachSimulationToScenarioExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.Inject(4, TimeSpan.FromMilliseconds(250), TimeSpan.FromSeconds(20)));
}
    }
