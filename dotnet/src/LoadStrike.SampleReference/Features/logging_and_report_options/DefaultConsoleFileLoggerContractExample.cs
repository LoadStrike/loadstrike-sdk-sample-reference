...
namespace LoadStrike.SampleReference.Features.LoggingAndReportOptions;
...
/// </summary>
public static class DefaultConsoleFileLoggerContractExample
{
    public static object Build()
    {
        // Default Console File Logger Contract is the feature being explained. The sample returns that focused object alongside a minimal run result.
        var feature = Runner();
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("default-console-file-logger-contract"))
            .WithRunnerKey(OrdersWorkflowPlaceholders.RunnerKey)
            .WithTestSuite("orders-reference")
            .WithTestName("default-console-file-logger-contract")
            .WithoutReports()
            .Run();
