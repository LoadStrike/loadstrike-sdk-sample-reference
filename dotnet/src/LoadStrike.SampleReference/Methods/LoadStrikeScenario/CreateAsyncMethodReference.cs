using System;
    ...
    /// <summary>Create an asynchronous scenario where the step callback returns a future/task.</summary>
    public static class CreateAsyncMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Create the GET scenario from an asynchronous callback.</summary>
public static object? CreateAsyncScenarioExample()
{
    return LoadStrikeScenario.CreateAsync("orders.get-by-id", ExecuteOrderGetAsync);
}

/// <summary>Create the async scenario and then attach a simple simulation.</summary>
public static object? CreateAsyncScenarioWithSimulationExample()
{
    return LoadStrikeScenario.CreateAsync("orders.get-by-id", ExecuteOrderGetAsync).WithLoadSimulations(LoadStrikeSimulation.IterationsForConstant(1, 3));
}
    }
