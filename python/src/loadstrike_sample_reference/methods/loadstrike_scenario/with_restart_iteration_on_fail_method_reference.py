...
class WithRestartIterationOnFailMethodReference:
    @staticmethod
    def enable_restart_on_fail_example() -> Any:
        """Retry iterations when the GET step fails."""
        return baseline_scenario().with_restart_iteration_on_fail(True)

    @staticmethod
    def disable_restart_on_fail_example() -> Any:
        """Leave iteration restart disabled."""
        return baseline_scenario().with_restart_iteration_on_fail(False)
