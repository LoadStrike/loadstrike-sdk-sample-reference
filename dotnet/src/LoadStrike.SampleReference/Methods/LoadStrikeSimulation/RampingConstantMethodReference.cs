using System;
    ...
    /// <summary>Ramp a constant concurrency level over time.</summary>
    public static class RampingConstantMethodReference
    {
...
{
    return LoadStrikeSimulation.RampingConstant(3, TimeSpan.FromSeconds(20));
}

/// <summary>Attach the simulation to the baseline GET scenario.</summary>
public static object? AttachSimulationToScenarioExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.RampingConstant(3, TimeSpan.FromSeconds(20)));
}
    }
