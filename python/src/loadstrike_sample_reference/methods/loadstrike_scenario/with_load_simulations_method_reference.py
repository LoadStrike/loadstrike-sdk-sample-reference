...
class WithLoadSimulationsMethodReference:
    @staticmethod
    def attach_single_simulation_example() -> Any:
        """Attach one pacing rule to the GET scenario."""
        return baseline_scenario().with_load_simulations(LoadStrikeSimulation.iterations_for_constant(1, 3))

    @staticmethod
    def attach_multiple_simulations_example() -> Any:
        """Attach multiple pacing rules in one call."""
        return baseline_scenario().with_load_simulations(LoadStrikeSimulation.iterations_for_constant(1, 3), LoadStrikeSimulation.pause(1))
