...
class GetScenarioTimerTimeMethodReference:
    @staticmethod
    def use_context_method_example() -> Any:
        """Call the public context helper directly from the scenario context surface."""
        return LoadStrikeScenario.create("orders.timer", lambda context: (context.get_scenario_timer_time(), LoadStrikeResponse.ok())[1])
