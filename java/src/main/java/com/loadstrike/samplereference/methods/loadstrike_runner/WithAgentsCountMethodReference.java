package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithAgentsCountMethodReference {
        private WithAgentsCountMethodReference() {}
