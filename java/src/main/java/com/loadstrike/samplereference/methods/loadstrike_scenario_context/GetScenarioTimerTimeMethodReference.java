package com.loadstrike.samplereference.methods.loadstrike_scenario_context;
      ...
      public final class GetScenarioTimerTimeMethodReference {
        private GetScenarioTimerTimeMethodReference() {}
...
public static Object UseContextMethodExample() {
    return LoadStrikeScenario.create("orders.timer", context -> { var ignored = context.getScenarioTimerTime(); return LoadStrikeResponse.ok(); });
}
