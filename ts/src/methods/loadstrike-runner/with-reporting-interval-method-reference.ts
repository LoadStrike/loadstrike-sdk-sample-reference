...
export class WithReportingIntervalMethodReference {
  /** Set a faster realtime reporting cadence. */
  static async UseFastIntervalExample(): Promise<unknown> {
      return baseRunner().withReportingInterval(1);
  }

  /** Set a slower reporting cadence for noisier runs. */
  static async UseSlowerIntervalExample(): Promise<unknown> {
