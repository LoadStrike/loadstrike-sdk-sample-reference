...
export class AddScenariosMethodReference {
  /** Attach two scenarios in a single batch call. */
  static async AddTwoScenariosExample(): Promise<unknown> {
  ...
  static async AddBatchAndKeepBuildingExample(): Promise<unknown> {
