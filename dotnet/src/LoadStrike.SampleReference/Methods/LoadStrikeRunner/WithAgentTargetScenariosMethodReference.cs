using System;
    ...
    /// <summary>Restrict agent-owned scenarios in distributed mode.</summary>
    public static class WithAgentTargetScenariosMethodReference
    {
...
{
    return LoadStrikeRunner.WithAgentTargetScenarios(baseContext(), "orders.get-by-id");
}

/// <summary>Target more than one named scenario in the same call.</summary>
public static object? SelectMultipleScenariosExample()
{
    return LoadStrikeRunner.WithAgentTargetScenarios(baseContext(), "orders.get-by-id", "orders.audit");
}
    }
