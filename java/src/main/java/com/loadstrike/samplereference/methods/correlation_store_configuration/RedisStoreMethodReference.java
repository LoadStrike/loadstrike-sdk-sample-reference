package com.loadstrike.samplereference.methods.correlation_store_configuration;
      ...
      public final class RedisStoreMethodReference {
        private RedisStoreMethodReference() {}
  ...
  public LoadStrikePluginData getData(LoadStrikeRunResult result) {
    return LoadStrikePluginData.create(pluginName());
        ...
        public static Object CreateCorrelationExample() {
            var options = new com.loadstrike.runtime.RedisCorrelationStoreOptions();
options.connectionString = "localhost:6379";
options.database = 1;
options.keyPrefix = "orders";
options.entryTtl = Duration.ofSeconds(300);
