using System;
    ...
    /// <summary>Select a subset of scenarios to execute.</summary>
    public static class WithTargetScenariosMethodReference
    {
...
{
    return LoadStrikeRunner.WithTargetScenarios(baseContext(), "orders.get-by-id");
}

/// <summary>Target more than one named scenario in the same call.</summary>
public static object? SelectMultipleScenariosExample()
{
    return LoadStrikeRunner.WithTargetScenarios(baseContext(), "orders.get-by-id", "orders.audit");
}
    }
