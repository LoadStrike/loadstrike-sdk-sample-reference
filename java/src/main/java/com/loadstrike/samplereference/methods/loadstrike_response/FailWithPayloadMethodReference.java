package com.loadstrike.samplereference.methods.loadstrike_response;
      ...
      public final class FailWithPayloadMethodReference {
        private FailWithPayloadMethodReference() {}
...
public static Object CreatePrimaryReplyExample() {
    return LoadStrikeResponse.failWithPayload(Map.of("error", "not-found"), "409", "conflict", 64, 3.2d);
}

/** Create an alternate reply shape that changes status or message metadata. */
public static Object CreateAlternateReplyExample() {
    return LoadStrikeResponse.failWithPayload(Map.of("error", "timeout"), "504", "retry", 8, 4.8d);
}
      }
