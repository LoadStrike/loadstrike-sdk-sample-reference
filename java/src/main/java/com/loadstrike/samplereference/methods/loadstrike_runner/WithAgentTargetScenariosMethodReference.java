package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithAgentTargetScenariosMethodReference {
        private WithAgentTargetScenariosMethodReference() {}
...
public static Object SelectOneScenarioExample() {
    return baseRunner().withAgentTargetScenarios("orders.get-by-id");
}

/** Target more than one named scenario in the same call. */
public static Object SelectMultipleScenariosExample() {
    return baseRunner().withAgentTargetScenarios("orders.get-by-id", "orders.audit");
}
      }
