...
class WithoutReportsMethodReference:
    @staticmethod
    def disable_reports_example() -> Any:
        """Disable local report writing for the baseline GET scenario."""
        return base_runner().without_reports()

    @staticmethod
    def disable_reports_after_report_folder_example() -> Any:
        """Disable reports even after setting a report folder."""
        return base_runner().with_report_folder("./artifacts/reports").without_reports()
