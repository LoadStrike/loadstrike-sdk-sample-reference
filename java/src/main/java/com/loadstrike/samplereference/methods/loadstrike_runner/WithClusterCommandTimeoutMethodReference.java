package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithClusterCommandTimeoutMethodReference {
        private WithClusterCommandTimeoutMethodReference() {}
...
public static Object ApplyShortTimeoutExample() {
    return baseRunner().withClusterCommandTimeout(5);
}

/** Apply a longer timeout to the runner. */
public static Object ApplyLongTimeoutExample() {
    return baseRunner().withClusterCommandTimeout(15);
}
      }
