...
export async function build() {
  ...
  const endpoint = otherBrokers().nats;
  const result = await LoadStrikeRunner.registerScenarios(scenario("nats")).withRunnerKey(RUNNER_KEY).withTestSuite("orders-reference").withTestName("nats").withoutReports().run();
