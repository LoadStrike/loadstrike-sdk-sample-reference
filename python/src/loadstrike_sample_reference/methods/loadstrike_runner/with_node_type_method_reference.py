...
class WithNodeTypeMethodReference:
    @staticmethod
    def use_coordinator_node_example() -> Any:
        """Set the runner to coordinator mode."""
        return base_runner().with_node_type("Coordinator")

    @staticmethod
    def use_agent_node_example() -> Any:
        """Set the runner to agent mode."""
        return base_runner().with_node_type("Agent")
