package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithScenarioCompletionTimeoutMethodReference {
        private WithScenarioCompletionTimeoutMethodReference() {}
...
public static Object ApplyShortTimeoutExample() {
    return baseRunner().withScenarioCompletionTimeout(5);
}

/** Apply a longer timeout to the runner. */
public static Object ApplyLongTimeoutExample() {
    return baseRunner().withScenarioCompletionTimeout(15);
}
      }
