package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithReportingSinksMethodReference {
        private WithReportingSinksMethodReference() {}
...
public static Object AttachOneSinkExample() {
    return baseRunner().withReportingSinks(new OrdersReportingSink());
}

/** Attach multiple sink instances in the same call. */
public static Object AttachTwoSinksExample() {
    return baseRunner().withReportingSinks(new OrdersReportingSink(), new OrdersReportingSink());
}
      }
