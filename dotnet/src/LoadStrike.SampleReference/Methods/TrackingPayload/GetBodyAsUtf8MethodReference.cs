using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerTrackingPayload;

    /// <summary>Read the tracking payload body as UTF-8 text where that helper exists.</summary>
    public static class GetBodyAsUtf8MethodReference
    {
...
{
    return buildTrackingPayload().GetBodyAsUtf8();
}
