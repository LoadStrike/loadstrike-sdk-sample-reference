using System;
    ...
    /// <summary>Create a reusable runner shell before adding scenarios.</summary>
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Create an empty runner before scenarios are added.</summary>
public static object? CreateEmptyRunnerExample()
{
    return LoadStrikeRunner.Create();
}

/// <summary>Create a runner and immediately attach the baseline GET scenario.</summary>
