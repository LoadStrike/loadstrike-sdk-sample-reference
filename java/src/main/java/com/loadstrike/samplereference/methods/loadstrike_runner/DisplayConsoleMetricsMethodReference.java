package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class DisplayConsoleMetricsMethodReference {
        private DisplayConsoleMetricsMethodReference() {}
...
public static Object ToggleOnExample() {
    return baseRunner().displayConsoleMetrics(true);
}

/** Apply the boolean option in its disabled state. */
public static Object ToggleOffExample() {
    return baseRunner().displayConsoleMetrics(false);
}
      }
