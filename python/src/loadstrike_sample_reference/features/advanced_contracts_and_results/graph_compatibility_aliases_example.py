...
FEATURE_OVERVIEW = "This feature area stays focused on the result contracts that come back after execution, such as report files, stats, sink errors, and compatibility aliases."
...
def build():
    ...
    result = _runner().run()
    feature = {"reportFiles": getattr(result, "reportFiles", None), "report_files": getattr(result, "report_files", None)}
