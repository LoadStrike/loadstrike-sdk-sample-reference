...
public static Object CreateBaselineScenarioExample() {
    return LoadStrikeScenario.create("orders.get-by-id", context -> executeOrderGet(context));
}
...
public static Object CreateScenarioAndAddSimulationExample() {
    return LoadStrikeScenario.create("orders.get-by-id", context -> executeOrderGet(context)).withLoadSimulations(LoadStrikeSimulation.iterationsForConstant(1, 3));
}
      }
