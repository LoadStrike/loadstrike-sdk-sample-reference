using System;
    ...
    /// <summary>Load run settings from a JSON config file.</summary>
    public static class LoadConfigMethodReference
    {
...
return LoadStrikeRunner.LoadConfig(baseContext(), paths.ConfigPath);
        }
