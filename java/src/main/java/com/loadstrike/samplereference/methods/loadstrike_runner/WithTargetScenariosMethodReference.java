package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithTargetScenariosMethodReference {
        private WithTargetScenariosMethodReference() {}
...
public static Object SelectOneScenarioExample() {
    return baseRunner().withTargetScenarios("orders.get-by-id");
}

/** Target more than one named scenario in the same call. */
public static Object SelectMultipleScenariosExample() {
    return baseRunner().withTargetScenarios("orders.get-by-id", "orders.audit");
}
      }
