...
export async function build() {
  ...
  const feature = { counter: LoadStrikeMetric.counter("orders_processed", "count", 0), gauge: LoadStrikeMetric.gauge("queue_depth", "items", 0), scenario: scenario("metrics") };
...
export function scenarioWithThreshold(nameSuffix, threshold) {
