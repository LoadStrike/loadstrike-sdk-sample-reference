package com.loadstrike.samplereference.methods.loadstrike_run_result;
      ...
      public final class FindScenarioStatsMethodReference {
        private FindScenarioStatsMethodReference() {}
