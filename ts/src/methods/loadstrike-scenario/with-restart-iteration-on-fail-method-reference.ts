...
export class WithRestartIterationOnFailMethodReference {
  /** Retry iterations when the GET step fails. */
  static async EnableRestartOnFailExample(): Promise<unknown> {
      return baselineScenario().withRestartIterationOnFail(true);
  }

  /** Leave iteration restart disabled. */
  static async DisableRestartOnFailExample(): Promise<unknown> {
