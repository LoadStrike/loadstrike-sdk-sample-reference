package com.loadstrike.samplereference.methods.loadstrike_scenario;
      ...
      public final class CreateAsyncMethodReference {
        private CreateAsyncMethodReference() {}
...
public static Object CreateAsyncScenarioExample() {
    return LoadStrikeScenario.createAsync("orders.get-by-id", context -> executeOrderGetAsyncStage(context));
}
...
public static Object CreateAsyncScenarioWithSimulationExample() {
    return LoadStrikeScenario.createAsync("orders.get-by-id", context -> executeOrderGetAsyncStage(context)).withLoadSimulations(LoadStrikeSimulation.iterationsForConstant(1, 3));
}
      }
