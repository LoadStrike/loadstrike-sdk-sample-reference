using System;
    ...
    /// <summary>Fetch scenario stats and fail fast when the scenario is missing.</summary>
    public static class GetScenarioStatsMethodReference
    {
...
{
    return scenarioStats().FindStepStats("get-order");
}
    }
