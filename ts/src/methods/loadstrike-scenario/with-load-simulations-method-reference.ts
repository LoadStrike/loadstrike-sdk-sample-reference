...
export class WithLoadSimulationsMethodReference {
  /** Attach one pacing rule to the GET scenario. */
  static async AttachSingleSimulationExample(): Promise<unknown> {
  ...
  static async AttachMultipleSimulationsExample(): Promise<unknown> {
      return baselineScenario().withLoadSimulations(LoadStrikeSimulation.iterationsForConstant(1, 3), LoadStrikeSimulation.pause(1));
  }
}
