...
class EmptyMethodReference:
    @staticmethod
    def create_empty_scenario_shell_example() -> Any:
        """Create an empty scenario shell before adding policies or tracking."""
        return LoadStrikeScenario.empty("orders.empty")

    @staticmethod
    def create_empty_scenario_and_warm_up_example() -> Any:
        """Start from an empty scenario and immediately disable warm-up."""
        return LoadStrikeScenario.empty("orders.empty").without_warm_up()
