...
class WithReportFormatsMethodReference:
    @staticmethod
    def write_text_and_html_reports_example() -> Any:
        """Write both text and HTML report outputs."""
        return base_runner().with_report_formats(LoadStrikeReportFormat.Txt, LoadStrikeReportFormat.Html)

    @staticmethod
    def write_markdown_only_report_example() -> Any:
        """Switch to a single markdown-style report format."""
        return base_runner().with_report_formats(LoadStrikeReportFormat.Md)
