...
class RedisStoreMethodReference:
    @staticmethod
    def create_correlation_example() -> Any:
        """Call the correlation helper directly with a concrete value."""
        options = RedisCorrelationStoreOptions(connection_string="localhost:6379", database=1, key_prefix="orders", entry_ttl_seconds=300)
        return CorrelationStoreConfiguration.redis_store(options)

    @staticmethod
    def use_correlation_example_in_tracked_flow() -> Any:
