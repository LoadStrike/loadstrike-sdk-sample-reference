...
class WithRuntimePoliciesMethodReference:
    @staticmethod
    def attach_one_policy_example() -> Any:
        """Attach one runtime policy implementation."""
        return base_runner().with_runtime_policies(OrdersRuntimePolicy())

    @staticmethod
    def attach_two_policies_example() -> Any:
        """Attach multiple runtime policy instances."""
        return base_runner().with_runtime_policies(OrdersRuntimePolicy(), OrdersRuntimePolicy())
