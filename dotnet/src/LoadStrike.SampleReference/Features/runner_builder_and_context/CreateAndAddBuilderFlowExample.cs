...
/// </summary>
public static class CreateAndAddBuilderFlowExample
{
    public static object Build()
    {
        // Create And Add Builder Flow is the feature being explained. The sample returns that focused object alongside a minimal run result.
        var feature = Runner();
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("create-and-add-builder-flow"))
            .WithRunnerKey(OrdersWorkflowPlaceholders.RunnerKey)
            .WithTestSuite("orders-reference")
            .WithTestName("create-and-add-builder-flow")
            .WithoutReports()
            .Run();
