using System;
    ...
    /// <summary>Start from an empty scenario shell.</summary>
    public static class EmptyMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Create an empty scenario shell before adding policies or tracking.</summary>
public static object? CreateEmptyScenarioShellExample()
{
    return LoadStrikeScenario.Empty("orders.empty");
}

/// <summary>Start from an empty scenario and immediately disable warm-up.</summary>
public static object? CreateEmptyScenarioAndWarmUpExample()
{
    return LoadStrikeScenario.Empty("orders.empty").WithoutWarmUp();
}
    }
