using System;
    ...
    /// <summary>Inject a logger factory or configuration delegate.</summary>
    public static class WithLoggerConfigMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Attach a logger factory directly on the runner.</summary>
public static object? AttachInlineLoggerFactoryExample()
{
    return LoadStrikeRunner.WithLoggerConfig(baseContext(), () => new LoggerConfiguration());
}

/// <summary>Attach an alternate logger factory on the context-driven overload.</summary>
public static object? AttachLoggerBeforeContextBuildExample()
{
    return LoadStrikeRunner.WithLoggerConfig(baseContext(), () => new LoggerConfiguration().MinimumLevel.Debug());
}
    }
