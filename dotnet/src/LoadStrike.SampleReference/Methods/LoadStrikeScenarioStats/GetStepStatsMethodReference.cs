using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerLoadStrikeScenarioStats;

    /// <summary>Fetch step stats and fail fast when the step is missing.</summary>
    public static class GetStepStatsMethodReference
    {
...
{
    return scenarioStats().GetStepStats("get-order");
}
