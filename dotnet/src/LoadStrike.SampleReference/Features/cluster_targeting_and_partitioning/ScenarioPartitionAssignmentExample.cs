...
namespace LoadStrike.SampleReference.Features.ClusterTargetingAndPartitioning;
...
/// </summary>
public static class ScenarioPartitionAssignmentExample
{
    public static object Build()
    {
        ...
        var partitionHints = new
                            {
                                Context = ClusterContext(),
                                PartitionKey = OrdersWorkflowPlaceholders.ExampleTenant,
                            };
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("scenario-partition-assignment"))
        ...
        return new { partitionHints, Result = result };
    }
...

        {
                ...
                Runner()
                    ...
                    .Configure(context =>
                        ...
                        context
                            ...
                            .WithNatsServerUrl(OrdersWorkflowPlaceholders.NatsServerUrl)
            ...
            public static LoadStrikeContext ClusterContext() =>
                ...
                ClusterRunner().BuildContext().WithTargetScenarios("orders.publish", "orders.reconcile");
}
