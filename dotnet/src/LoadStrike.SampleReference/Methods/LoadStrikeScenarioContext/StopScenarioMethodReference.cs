using System;
    ...
    /// <summary>Stop the current scenario from inside a step.</summary>
    public static class StopScenarioMethodReference
    {
...
{
    return LoadStrikeScenario.Create("orders.stop", context => { context.StopScenario("orders.stop", "stop-now"); return Task.FromResult(LoadStrikeResponse.Ok()); });
}
