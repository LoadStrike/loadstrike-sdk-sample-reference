package com.loadstrike.samplereference.methods.loadstrike_step;
      ...
      public final class RunAsyncMethodReference {
        private RunAsyncMethodReference() {}
...
public static Object RunAsyncStepExample() {
    return LoadStrikeStep.runAsync("get-order", createStepContext(), () -> CompletableFuture.completedFuture(createOrderReply()));
}

/** Project the async step reply to the untyped reply contract. */
public static Object RunAsyncStepAndProjectReplyExample() {
    return LoadStrikeStep.runAsync("get-order", createStepContext(), () -> CompletableFuture.completedFuture(createOrderReply())).thenApply(reply -> reply.asReply());
}
      }
