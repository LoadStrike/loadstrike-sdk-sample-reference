package com.loadstrike.samplereference.methods.loadstrike_scenario_context;
      ...
      public final class StopCurrentTestMethodReference {
        private StopCurrentTestMethodReference() {}
...
public static Object UseContextMethodExample() {
    return LoadStrikeScenario.create("orders.stop-test", context -> { context.stopCurrentTest("stop-now"); return LoadStrikeResponse.ok(); });
}
