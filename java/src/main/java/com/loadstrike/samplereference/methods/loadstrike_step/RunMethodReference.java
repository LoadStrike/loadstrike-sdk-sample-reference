package com.loadstrike.samplereference.methods.loadstrike_step;
      ...
      public final class RunMethodReference {
        private RunMethodReference() {}
...
public static Object RunNamedStepExample() {
    return LoadStrikeScenario.create("orders.step", context -> LoadStrikeStep.run("get-order", context, () -> createOrderReply()).asReply());
}
