...
namespace LoadStrike.SampleReference.Features.AdvancedReusableContextAndPayloadBuilder;
...
/// </summary>
public static class TrackingPayloadBuilderExample
{
    public static object Build()
    {
        ...
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("tracking-payload-builder"))
        ...
        return new { payloadBuilder, Result = result };
    }
