...
namespace LoadStrike.SampleReference.Features.ClusterOverview;
...
/// </summary>
public static class CoordinatorAgentOverNatsExample
{
    public static object Build()
    {
        ...
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("coordinator-agent-over-nats"))
        ...
        return new { feature, Result = result };
    }
