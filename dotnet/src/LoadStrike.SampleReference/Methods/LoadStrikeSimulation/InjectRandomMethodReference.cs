using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerLoadStrikeSimulation;

    /// <summary>Randomize injection inside a configured range.</summary>
    public static class InjectRandomMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Create the simulation shape named by this method reference.</summary>
public static object? CreatePrimarySimulationExample()
{
    return LoadStrikeSimulation.InjectRandom(2, 4, TimeSpan.FromMilliseconds(250), TimeSpan.FromSeconds(20));
}

/// <summary>Attach the simulation to the baseline GET scenario.</summary>
public static object? AttachSimulationToScenarioExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.InjectRandom(2, 4, TimeSpan.FromMilliseconds(250), TimeSpan.FromSeconds(20)));
}
    }
