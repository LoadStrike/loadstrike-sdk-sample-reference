...
class StopScenarioMethodReference:
    @staticmethod
    def use_context_method_example() -> Any:
        """Call the public context helper directly from the scenario context surface."""
        return LoadStrikeScenario.create("orders.stop", lambda context: (context.stop_scenario("orders.stop", "stop-now"), LoadStrikeResponse.ok())[1])
