package com.loadstrike.samplereference.methods.loadstrike_threshold;
      ...
      public final class CreateStepMethodReference {
        private CreateStepMethodReference() {}
...
public static Object CreateThresholdExample() {
    return LoadStrikeThreshold.CreateStep("get-order", "AllOkCount", "gte", 1d, 1, 2d);
}

/** Attach the threshold to the baseline GET scenario. */
public static Object AttachThresholdToScenarioExample() {
    return baselineScenario().withThresholds(LoadStrikeThreshold.CreateStep("get-order", "AllOkCount", "gte", 1d, 1, 2d));
}
      }
