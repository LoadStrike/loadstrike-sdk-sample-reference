...
def build():
    ...
    feature = {"scenario": _scenario("named-steps"), "step_helper": _step_reply}
    result = (LoadStrikeRunner.register_scenarios(_scenario("named-steps")).with_runner_key(placeholders.RUNNER_KEY).with_test_suite("orders-reference").with_test_name("named-steps").without_reports().run())
