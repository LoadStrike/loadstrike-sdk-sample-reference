...
namespace LoadStrike.SampleReference.Features.WorkerPlugins;

/// <summary>
/// /// This feature area focuses on the worker-plugin lifecycle, registration, and custom plugin tables in final results. ///
/// </summary>
public static class InitStartGetDataStopDisposeExample
{
    public static object Build()
    {
        ...
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("init-start-get-data-stop-dispose"))
        ...
        return new { plugin, Result = result };
    }
