package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class EnableLocalDevClusterMethodReference {
        private EnableLocalDevClusterMethodReference() {}
...
public static Object EnableOnExample() {
    return baseRunner().enableLocalDevCluster(true);
}

/** Apply the boolean option in its disabled state. */
public static Object EnableOffExample() {
    return baseRunner().enableLocalDevCluster(false);
}
      }
