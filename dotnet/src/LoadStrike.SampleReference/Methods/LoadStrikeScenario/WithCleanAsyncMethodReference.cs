using System;
    ...
    /// <summary>Attach an asynchronous cleanup hook.</summary>
    public static class WithCleanAsyncMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Attach an asynchronous lifecycle hook with no extra side effects.</summary>
public static object? AttachAsyncNoOpHookExample()
{
    return baselineScenario().WithCleanAsync(context => Task.CompletedTask);
}

/// <summary>Attach an asynchronous lifecycle hook that still registers a metric.</summary>
public static object? AttachAsyncMetricHookExample()
{
    return baselineScenario().WithCleanAsync(context => Task.CompletedTask);
}
    }
