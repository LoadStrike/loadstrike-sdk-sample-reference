...
export class FailWithPayloadMethodReference {
  /** Create the primary reply shape for this helper. */
  static async CreatePrimaryReplyExample(): Promise<unknown> {
      return LoadStrikeResponse.failWithPayload({ error: "not-found" }, "409", "conflict", 64, 3.2);
  }
  ...
  static async CreateAlternateReplyExample(): Promise<unknown> {
      return LoadStrikeResponse.failWithPayload({ error: "timeout" }, "504", "retry", 8, 4.8);
  }
}
