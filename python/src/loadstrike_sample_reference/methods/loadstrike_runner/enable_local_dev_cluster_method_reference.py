...
class EnableLocalDevClusterMethodReference:
    @staticmethod
    def enable_on_example() -> Any:
        """Apply the boolean option in its enabled state."""
        return base_runner().enable_local_dev_cluster(True)

    @staticmethod
    def enable_off_example() -> Any:
        """Apply the boolean option in its disabled state."""
        return base_runner().enable_local_dev_cluster(False)
