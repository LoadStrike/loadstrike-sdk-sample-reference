package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithRunnerKeyMethodReference {
        private WithRunnerKeyMethodReference() {}
...
public static Object ApplyPrimaryValueExample() {
    return baseRunner().withRunnerKey("runner_dummy_orders_reference");
}

/** Show the same method with a second concrete value. */
public static Object ApplyAlternateValueExample() {
    return baseRunner().withRunnerKey("runner_dummy_checkout_reference");
}
      }
