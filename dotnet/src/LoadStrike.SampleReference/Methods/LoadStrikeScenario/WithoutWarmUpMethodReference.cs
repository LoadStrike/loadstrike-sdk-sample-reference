using System;
    ...
    /// <summary>Disable warm-up entirely for a scenario.</summary>
    public static class WithoutWarmUpMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Disable warm-up for the GET scenario.</summary>
public static object? DisableWarmUpExample()
{
    return baselineScenario().WithoutWarmUp();
}

/// <summary>Disable warm-up after attaching a simulation.</summary>
public static object? DisableWarmUpAfterSimulationExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.IterationsForConstant(1, 3)).WithoutWarmUp();
}
    }
