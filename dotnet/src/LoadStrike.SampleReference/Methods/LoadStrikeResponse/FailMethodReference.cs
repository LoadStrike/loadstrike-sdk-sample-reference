using System;
    ...
    /// <summary>Return a failed reply with a status code and message.</summary>
    public static class FailMethodReference
    {
...
{
    return LoadStrikeResponse.Fail(statusCode: "404", message: "not-found", sizeBytes: 64, customLatencyMs: 3.2);
}
...
{
    return LoadStrikeResponse.Fail(statusCode: "503", message: "retry", sizeBytes: 0, customLatencyMs: 1.5);
}
    }
