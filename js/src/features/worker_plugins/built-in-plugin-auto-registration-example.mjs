...
export async function build() {
  // Built In Plugin Auto Registration is the main thing being demonstrated here. Keep the runner flow simple and change only this option when comparing behavior.
  const runner = runner().configure((context) => context.withWorkerPlugins(new OrdersWorkerPlugin()));
