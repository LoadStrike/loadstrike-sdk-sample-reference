package com.loadstrike.samplereference.methods.loadstrike_scenario;
      ...
      public final class WithThresholdsMethodReference {
        private WithThresholdsMethodReference() {}
...
public static Object AttachScenarioThresholdExample() {
    return baselineScenario().withThresholds(LoadStrikeThreshold.CreateScenario("AllRequestCount", "gte", 1d, 1, 2d));
}

/** Attach more than one threshold in the same call. */
public static Object AttachScenarioAndStepThresholdExample() {
    return baselineScenario().withThresholds(LoadStrikeThreshold.CreateScenario("AllRequestCount", "gte", 1d, 1, 2d), LoadStrikeThreshold.CreateStep("get-order", "AllOkCount", "gte", 1d, 1, 2d));
}
      }
