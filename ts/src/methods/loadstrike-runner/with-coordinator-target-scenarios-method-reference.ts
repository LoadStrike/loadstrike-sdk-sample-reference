...
export class WithCoordinatorTargetScenariosMethodReference {
  /** Target a single scenario by name. */
  static async SelectOneScenarioExample(): Promise<unknown> {
  ...
  static async SelectMultipleScenariosExample(): Promise<unknown> {
