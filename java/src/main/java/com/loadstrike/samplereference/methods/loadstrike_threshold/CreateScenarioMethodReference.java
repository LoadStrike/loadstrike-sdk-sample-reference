package com.loadstrike.samplereference.methods.loadstrike_threshold;
      ...
      public final class CreateScenarioMethodReference {
        private CreateScenarioMethodReference() {}
...
public static Object CreateThresholdExample() {
    return LoadStrikeThreshold.CreateScenario("AllRequestCount", "gte", 1d, 1, 2d);
}
