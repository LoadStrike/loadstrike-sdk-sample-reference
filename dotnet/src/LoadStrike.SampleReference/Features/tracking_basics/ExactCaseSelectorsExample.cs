...
/// </summary>
public static class ExactCaseSelectorsExample
{
    public static object Build()
    {
        ...
        var trackingConfig = new CrossPlatformTrackingConfiguration
                            {
                                Source = HttpSource(),
        ...
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("exact-case-selectors"))
        ...
        return new { trackingConfig, Result = result };
    }
