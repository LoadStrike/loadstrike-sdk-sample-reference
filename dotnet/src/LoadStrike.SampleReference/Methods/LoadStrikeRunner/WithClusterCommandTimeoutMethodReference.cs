using System;
    ...
    /// <summary>Set the cluster command timeout.</summary>
    public static class WithClusterCommandTimeoutMethodReference
    {
...
{
    return baseRunner().WithClusterCommandTimeout(TimeSpan.FromSeconds(5));
}

/// <summary>Apply a longer timeout to the runner.</summary>
public static object? ApplyLongTimeoutExample()
{
    return baseRunner().WithClusterCommandTimeout(TimeSpan.FromSeconds(15));
}
    }
