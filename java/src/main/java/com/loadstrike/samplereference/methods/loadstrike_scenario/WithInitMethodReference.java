package com.loadstrike.samplereference.methods.loadstrike_scenario;
      ...
      public final class WithInitMethodReference {
        private WithInitMethodReference() {}
...
public static Object AttachNoOpHookExample() {
    return baselineScenario().withInit(context -> null);
}
...
public static Object AttachMetricAwareHookExample() {
    return baselineScenario().withInit(context -> { context.registerMetric(LoadStrikeMetric.counter("orders_seen", "count")); return null; });
}
      }
