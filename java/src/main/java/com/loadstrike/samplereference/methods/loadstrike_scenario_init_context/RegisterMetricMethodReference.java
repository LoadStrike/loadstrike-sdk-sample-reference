package com.loadstrike.samplereference.methods.loadstrike_scenario_init_context;
      ...
      public final class RegisterMetricMethodReference {
        private RegisterMetricMethodReference() {}
...
/** Show the same helper in the baseline GET-step flow. */
        public static Object UseContextMethodInStepExample() {
            var metric = LoadStrikeMetric.counter("orders_total", "count");
