using System;
    ...
    /// <summary>Set a warm-up duration before bombing.</summary>
    public static class WithWarmUpDurationMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Set a short warm-up duration.</summary>
public static object? UseShortWarmUpExample()
{
    return baselineScenario().WithWarmUpDuration(TimeSpan.FromSeconds(2));
}

/// <summary>Set a longer warm-up duration.</summary>
public static object? UseLongWarmUpExample()
{
    return baselineScenario().WithWarmUpDuration(TimeSpan.FromSeconds(10));
}
    }
