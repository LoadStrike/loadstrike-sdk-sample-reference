...
class WithReportingIntervalMethodReference:
    @staticmethod
    def use_fast_interval_example() -> Any:
        """Set a faster realtime reporting cadence."""
        return base_runner().with_reporting_interval(1)

    @staticmethod
    def use_slower_interval_example() -> Any:
        """Set a slower reporting cadence for noisier runs."""
        return base_runner().with_reporting_interval(5)
