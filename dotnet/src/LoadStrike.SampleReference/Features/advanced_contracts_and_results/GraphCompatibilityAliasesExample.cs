...
namespace LoadStrike.SampleReference.Features.AdvancedContractsAndResults;
...
/// </summary>
public static class GraphCompatibilityAliasesExample
{
    public static object Build()
    {
        ...
        var feature = new { result.reportFiles, result.ReportFiles, result.scenarioStats, result.ScenarioStats };
