...
class RegisterMetricMethodReference:
    @staticmethod
    def use_context_method_example() -> Any:
    ...
    @staticmethod
    def use_context_method_in_step_example() -> Any:
        """Show the same helper in the baseline GET-step flow."""
        metric = LoadStrikeMetric.counter("orders_total", "count")
