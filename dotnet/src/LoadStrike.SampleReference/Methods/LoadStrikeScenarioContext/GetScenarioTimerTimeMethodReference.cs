using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerLoadStrikeScenarioContext;

    /// <summary>Read the elapsed scenario timer from inside a step.</summary>
    public static class GetScenarioTimerTimeMethodReference
    {
...
{
    return LoadStrikeScenario.Create("orders.timer", context => { var _ = context.GetScenarioTimerTime(); return Task.FromResult(LoadStrikeResponse.Ok()); });
}
