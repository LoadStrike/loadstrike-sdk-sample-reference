...
class DisplayConsoleMetricsMethodReference:
    @staticmethod
    def toggle_on_example() -> Any:
        """Apply the boolean option in its enabled state."""
        return base_runner().display_console_metrics(True)

    @staticmethod
    def toggle_off_example() -> Any:
        """Apply the boolean option in its disabled state."""
        return base_runner().display_console_metrics(False)
