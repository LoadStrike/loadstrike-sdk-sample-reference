...
class WithoutWarmUpMethodReference:
    @staticmethod
    def disable_warm_up_example() -> Any:
        """Disable warm-up for the GET scenario."""
        return baseline_scenario().without_warm_up()

    @staticmethod
    def disable_warm_up_after_simulation_example() -> Any:
        """Disable warm-up after attaching a simulation."""
        return baseline_scenario().with_load_simulations(LoadStrikeSimulation.iterations_for_constant(1, 3)).without_warm_up()
