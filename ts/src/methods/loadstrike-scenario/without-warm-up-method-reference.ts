...
export class WithoutWarmUpMethodReference {
  /** Disable warm-up for the GET scenario. */
  static async DisableWarmUpExample(): Promise<unknown> {
      return baselineScenario().withoutWarmUp();
  }

  /** Disable warm-up after attaching a simulation. */
  static async DisableWarmUpAfterSimulationExample(): Promise<unknown> {
