package com.loadstrike.samplereference.methods.loadstrike_scenario;
      ...
      public final class WithWarmUpDurationMethodReference {
        private WithWarmUpDurationMethodReference() {}
...
public static Object UseShortWarmUpExample() {
    return baselineScenario().withWarmUpDuration(2);
}

/** Set a longer warm-up duration. */
public static Object UseLongWarmUpExample() {
    return baselineScenario().withWarmUpDuration(10);
}
      }
