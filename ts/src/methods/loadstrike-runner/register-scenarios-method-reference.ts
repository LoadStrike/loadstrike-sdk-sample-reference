...
export class RegisterScenariosMethodReference {
  /** Register one baseline GET scenario in a single call. */
  static async RegisterSingleScenarioExample(): Promise<unknown> {
  ...
  static async RegisterMultipleScenariosExample(): Promise<unknown> {
