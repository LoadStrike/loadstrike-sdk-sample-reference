...
export async function build() {
  ...
  const feature = scenario("async-lifecycle");
  const result = await LoadStrikeRunner.registerScenarios(scenario("async-lifecycle-hooks")).withRunnerKey(RUNNER_KEY).withTestSuite("orders-reference").withTestName("async-lifecycle-hooks").withoutReports().run();
