...
class WithRuntimePolicyErrorModeMethodReference:
    @staticmethod
    def continue_on_policy_error_example() -> Any:
        """Continue when policy hooks fail."""
        return base_runner().with_runtime_policy_error_mode("continue")

    @staticmethod
    def fail_on_policy_error_example() -> Any:
        """Fail the run when policy hooks fail."""
        return base_runner().with_runtime_policy_error_mode("fail")
