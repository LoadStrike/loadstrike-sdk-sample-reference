...
class BuildContextMethodReference:
    @staticmethod
    def build_reusable_context_example() -> Any:
        """Freeze the fluent runner state into a reusable context."""
        return base_runner().build_context()

    @staticmethod
    def build_context_after_renaming_example() -> Any:
        """Build a context after overriding the sample test name."""
        return base_runner().with_test_name("orders-build-context").build_context()
