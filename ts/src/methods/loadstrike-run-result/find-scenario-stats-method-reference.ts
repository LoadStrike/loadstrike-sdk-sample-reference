...
export class FindScenarioStatsMethodReference {
  /** Read data back from the run result surface with this helper. */
  static async ReadRunResultsExample(): Promise<unknown> {
  ...
  static async ReadDeeperResultSurfaceExample(): Promise<unknown> {
