package com.loadstrike.samplereference.methods.loadstrike_scenario;
      ...
      public final class WithLoadSimulationsMethodReference {
        private WithLoadSimulationsMethodReference() {}
...
public static Object AttachMultipleSimulationsExample() {
    return baselineScenario().withLoadSimulations(LoadStrikeSimulation.iterationsForConstant(1, 3), LoadStrikeSimulation.pause(1d));
}
      }
