using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerLoadStrikePluginData;

    /// <summary>Create a plugin data container.</summary>
...
{
    return LoadStrikePluginData.Create("orders-plugin");
}
