using System;
    ...
    /// <summary>Stop the current test session from inside a step.</summary>
    public static class StopCurrentTestMethodReference
    {
...
{
    return LoadStrikeScenario.Create("orders.stop-test", context => { context.StopCurrentTest("stop-now"); return Task.FromResult(LoadStrikeResponse.Ok()); });
}
