using System;
    ...
    /// <summary>Attach one or more load simulations.</summary>
    public static class WithLoadSimulationsMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Attach one pacing rule to the GET scenario.</summary>
public static object? AttachSingleSimulationExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.IterationsForConstant(1, 3));
}

/// <summary>Attach multiple pacing rules in one call.</summary>
public static object? AttachMultipleSimulationsExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.IterationsForConstant(1, 3), LoadStrikeSimulation.Pause(TimeSpan.FromSeconds(1)));
}
    }
