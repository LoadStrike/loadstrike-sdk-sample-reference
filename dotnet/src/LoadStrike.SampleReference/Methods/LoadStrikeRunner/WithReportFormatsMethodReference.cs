using System;
    ...
    /// <summary>Choose one or more local report formats.</summary>
    public static class WithReportFormatsMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Write both text and HTML report outputs.</summary>
public static object? WriteTextAndHtmlReportsExample()
{
    return LoadStrikeRunner.WithReportFormats(baseContext(), LoadStrikeReportFormat.Txt, LoadStrikeReportFormat.Html);
}

/// <summary>Switch to a single markdown-style report format.</summary>
public static object? WriteMarkdownOnlyReportExample()
{
    return LoadStrikeRunner.WithReportFormats(baseContext(), LoadStrikeReportFormat.Md);
}
    }
