using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerLoadStrikeReply;

    /// <summary>Project a typed reply into the untyped reply contract where that helper exists.</summary>
    public static class AsReplyMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Project a typed reply into the untyped reply contract.</summary>
public static object? ProjectTypedReplyExample()
{
    return LoadStrikeResponse.Ok(new { orderId = 42 }, statusCode: "200", sizeBytes: 128, message: "ok", customLatencyMs: 3.2).AsReply();
}

/// <summary>Project a failed typed reply into the untyped reply contract.</summary>
public static object? ProjectFailedTypedReplyExample()
{
    return LoadStrikeResponse.Fail(new { error = "not-found" }, statusCode: "404", message: "missing", sizeBytes: 64, customLatencyMs: 3.2).AsReply();
}
    }
