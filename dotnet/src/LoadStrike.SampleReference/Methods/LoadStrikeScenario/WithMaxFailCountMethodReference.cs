using System;
    ...
    /// <summary>Stop a scenario after a configured number of failures.</summary>
    public static class WithMaxFailCountMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Stop the scenario after the first failure.</summary>
public static object? StopAfterOneFailureExample()
{
    return baselineScenario().WithMaxFailCount(1);
}

/// <summary>Allow a few failures before stopping the scenario.</summary>
public static object? StopAfterThreeFailuresExample()
{
    return baselineScenario().WithMaxFailCount(3);
}
    }
