package com.loadstrike.samplereference.methods.loadstrike_simulation;
      ...
      public final class RampingInjectMethodReference {
        private RampingInjectMethodReference() {}
...
public static Object CreatePrimarySimulationExample() {
    return LoadStrikeSimulation.rampingInject(5, 0.25d, 20d);
}

/** Attach the simulation to the baseline GET scenario. */
public static Object AttachSimulationToScenarioExample() {
    return baselineScenario().withLoadSimulations(LoadStrikeSimulation.rampingInject(5, 0.25d, 20d));
}
      }
