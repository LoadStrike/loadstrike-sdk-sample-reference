...
def build():
    ...
    result = _runner().run()
    feature = {"failedThresholds": getattr(result, "failed_thresholds", getattr(result, "failedThresholds", None)), "passedThresholds": getattr(result, "passed_thresholds", getattr(result, "passedThresholds", None))}
