...
export class WithoutReportsMethodReference {
  /** Disable local report writing for the baseline GET scenario. */
  static async DisableReportsExample(): Promise<unknown> {
      return baseRunner().withoutReports();
  }

  /** Disable reports even after setting a report folder. */
  static async DisableReportsAfterReportFolderExample(): Promise<unknown> {
