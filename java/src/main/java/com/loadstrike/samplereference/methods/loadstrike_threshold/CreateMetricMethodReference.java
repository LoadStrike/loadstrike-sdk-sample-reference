package com.loadstrike.samplereference.methods.loadstrike_threshold;
      ...
      public final class CreateMetricMethodReference {
        private CreateMetricMethodReference() {}
...
public static Object CreateThresholdExample() {
    return LoadStrikeThreshold.CreateMetric("DurationMs", "lte", 500d, 1, 2d);
}

/** Attach the threshold to the baseline GET scenario. */
public static Object AttachThresholdToScenarioExample() {
    return baselineScenario().withThresholds(LoadStrikeThreshold.CreateMetric("DurationMs", "lte", 500d, 1, 2d));
}
      }
