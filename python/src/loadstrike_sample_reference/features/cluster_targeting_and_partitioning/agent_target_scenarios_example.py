...
def build():
    ...
    context = _runner().build_context().with_cluster_id("orders-cluster").with_agent_group("orders-agents").with_agents_count(3).with_agent_target_scenarios("orders.publish")
