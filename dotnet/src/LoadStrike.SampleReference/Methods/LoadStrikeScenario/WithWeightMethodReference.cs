using System;
    ...
    /// <summary>Change the relative scenario weight.</summary>
    public static class WithWeightMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Give the GET scenario a lower relative weight.</summary>
public static object? SetLowerWeightExample()
{
    return baselineScenario().WithWeight(1);
}

/// <summary>Give the GET scenario a higher relative weight.</summary>
public static object? SetHigherWeightExample()
{
    return baselineScenario().WithWeight(5);
}
    }
