using System;
    ...
    /// <summary>Pause a scenario between active simulations.</summary>
    public static class PauseMethodReference
    {
...
{
    return LoadStrikeSimulation.Pause(TimeSpan.FromSeconds(1));
}

/// <summary>Attach the simulation to the baseline GET scenario.</summary>
public static object? AttachSimulationToScenarioExample()
{
    return baselineScenario().WithLoadSimulations(LoadStrikeSimulation.Pause(TimeSpan.FromSeconds(1)));
}
    }
