...
export async function build() {
  // Custom Sinks is the main thing being demonstrated here. Keep the runner flow simple and change only this option when comparing behavior.
  const runner = { sink: new OrdersReportingSink(), runner: runner().configure((context) => context.withReportingSinks(new OrdersReportingSink())) };
