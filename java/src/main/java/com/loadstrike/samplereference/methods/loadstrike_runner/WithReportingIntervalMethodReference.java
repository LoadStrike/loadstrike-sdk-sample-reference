package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithReportingIntervalMethodReference {
        private WithReportingIntervalMethodReference() {}
