package com.loadstrike.samplereference.methods.loadstrike_threshold;
      ...
      public final class ScenarioPredicateMethodReference {
        private ScenarioPredicateMethodReference() {}
...
public static Object CreateThresholdExample() {
    return LoadStrikeThreshold.scenarioPredicate(stats -> stats.allOkCount >= 1, 1, 2d);
}

/** Attach the threshold to the baseline GET scenario. */
public static Object AttachThresholdToScenarioExample() {
    return baselineScenario().withThresholds(LoadStrikeThreshold.scenarioPredicate(stats -> stats.allOkCount >= 1, 1, 2d));
}
      }
