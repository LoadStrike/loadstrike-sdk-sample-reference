...
class RunMethodReference:
    @staticmethod
    def run_named_step_example() -> Any:
        """Execute the baseline GET request inside a named step."""
        return LoadStrikeScenario.create("orders.step", lambda context: LoadStrikeStep.run("get-order", context, lambda: create_order_reply()).as_reply())

    @staticmethod
    def run_step_and_project_reply_example() -> Any:
