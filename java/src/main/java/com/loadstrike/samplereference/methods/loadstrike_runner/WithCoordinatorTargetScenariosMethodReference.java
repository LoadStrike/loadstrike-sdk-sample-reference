package com.loadstrike.samplereference.methods.loadstrike_runner;
      ...
      public final class WithCoordinatorTargetScenariosMethodReference {
        private WithCoordinatorTargetScenariosMethodReference() {}
...
public static Object SelectOneScenarioExample() {
    return baseRunner().withCoordinatorTargetScenarios("orders.get-by-id");
}

/** Target more than one named scenario in the same call. */
public static Object SelectMultipleScenariosExample() {
    return baseRunner().withCoordinatorTargetScenarios("orders.get-by-id", "orders.audit");
}
      }
