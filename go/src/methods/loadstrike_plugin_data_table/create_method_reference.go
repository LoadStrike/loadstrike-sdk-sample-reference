package loadstrike_plugin_data_table
...
func createWriteTempConfigFiles() createTempConfigPaths {
	return createTempConfigPaths{
        ...
        // Create the plugin data or table object directly.
func (reference CreateMethodReference) CreatePluginDataExample() any {
    return loadstrike.CreatePluginDataTable("Orders")
}

// Build on the created object to show how the method fits into the reporting surface.
func (reference CreateMethodReference) AttachPluginDataExample() any {
    return newCreateOrdersWorkerPlugin().GetData(loadstrike.LoadStrikeRunResult{})
}
