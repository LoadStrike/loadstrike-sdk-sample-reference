using System;
    ...
    /// <summary>Return a successful reply for a GET /orders/{id} style request.</summary>
    public static class OkMethodReference
    {
...
{
    return LoadStrikeResponse.Ok(statusCode: "200", sizeBytes: 128, message: "ok", customLatencyMs: 3.2);
}
...
{
    return LoadStrikeResponse.Ok(statusCode: "204", sizeBytes: 0, message: "cached", customLatencyMs: 1.1);
}
    }
