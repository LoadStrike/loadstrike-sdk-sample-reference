using System;
    ...
    namespace LoadStrike.SampleReference.Methods.OwnerCorrelationStoreConfiguration;

    /// <summary>Configure Redis-backed correlation storage.</summary>
    public static class RedisStoreMethodReference
    {
...
private sealed class OrdersWorkerPlugin : ILoadStrikeWorkerPlugin
{
    ...
    public Task Dispose() => Task.CompletedTask;
        ...
        /// <summary>Call the correlation helper directly with a concrete value.</summary>
public static object? CreateCorrelationExample()
{
    return CorrelationStoreConfiguration.RedisStore(new RedisCorrelationStoreOptions { ConnectionString = "localhost:6379", Database = 1, KeyPrefix = "orders", EntryTtl = TimeSpan.FromMinutes(5) });
}

/// <summary>Show how the same helper fits into the tracked source/destination example.</summary>
public static object? UseCorrelationExampleInTrackedFlow()
{
