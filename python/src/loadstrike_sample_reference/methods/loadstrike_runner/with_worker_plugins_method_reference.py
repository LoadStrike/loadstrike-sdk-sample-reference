...
class WithWorkerPluginsMethodReference:
    @staticmethod
    def attach_one_worker_plugin_example() -> Any:
        """Attach one worker plugin instance."""
        return base_runner().with_worker_plugins(OrdersWorkerPlugin())

    @staticmethod
    def attach_two_worker_plugins_example() -> Any:
        """Attach multiple worker plugins in one call."""
        return base_runner().with_worker_plugins(OrdersWorkerPlugin(), OrdersWorkerPlugin())
