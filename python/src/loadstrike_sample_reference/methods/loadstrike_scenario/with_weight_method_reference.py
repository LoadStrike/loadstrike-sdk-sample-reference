...
class WithWeightMethodReference:
    @staticmethod
    def set_lower_weight_example() -> Any:
        """Give the GET scenario a lower relative weight."""
        return baseline_scenario().with_weight(1)

    @staticmethod
    def set_higher_weight_example() -> Any:
        """Give the GET scenario a higher relative weight."""
        return baseline_scenario().with_weight(5)
