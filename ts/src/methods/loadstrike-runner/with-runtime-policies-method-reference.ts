...
export class WithRuntimePoliciesMethodReference {
  /** Attach one runtime policy implementation. */
  static async AttachOnePolicyExample(): Promise<unknown> {
      return LoadStrikeRunner.WithRuntimePolicies(baseContext(), new OrdersRuntimePolicy());
  }

  /** Attach multiple runtime policy instances. */
  static async AttachTwoPoliciesExample(): Promise<unknown> {
      return LoadStrikeRunner.WithRuntimePolicies(baseContext(), new OrdersRuntimePolicy(), new OrdersRuntimePolicy());
  }
}
