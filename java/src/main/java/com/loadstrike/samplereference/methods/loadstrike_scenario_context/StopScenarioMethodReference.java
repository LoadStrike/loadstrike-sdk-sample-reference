package com.loadstrike.samplereference.methods.loadstrike_scenario_context;
      ...
      public final class StopScenarioMethodReference {
        private StopScenarioMethodReference() {}
...
public static Object UseContextMethodExample() {
    return LoadStrikeScenario.create("orders.stop", context -> { context.stopScenario("orders.stop", "stop-now"); return LoadStrikeResponse.ok(); });
}
