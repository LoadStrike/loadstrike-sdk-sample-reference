...
class WithWarmUpDurationMethodReference:
    @staticmethod
    def use_short_warm_up_example() -> Any:
        """Set a short warm-up duration."""
        return baseline_scenario().with_warm_up_duration(2)

    @staticmethod
    def use_long_warm_up_example() -> Any:
        """Set a longer warm-up duration."""
        return baseline_scenario().with_warm_up_duration(10)
