...
namespace LoadStrike.SampleReference.Features.RuntimePolicies;
...
/// </summary>
public static class ShouldRunScenarioExample
{
    public static object Build()
    {
        ...
        var result = LoadStrikeRunner
            .RegisterScenarios(Scenario("should-run-scenario"))
        ...
        return new { policy, Result = result };
    }
