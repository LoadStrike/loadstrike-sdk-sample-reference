using System;
    ...
    /// <summary>Tune runner-key validation timeout.</summary>
    public static class WithLicenseValidationTimeoutMethodReference
    {
...
{
    return LoadStrikeRunner.WithLicenseValidationTimeout(baseContext(), TimeSpan.FromSeconds(5));
}

/// <summary>Apply a longer timeout to the runner.</summary>
public static object? ApplyLongTimeoutExample()
{
    return LoadStrikeRunner.WithLicenseValidationTimeout(baseContext(), TimeSpan.FromSeconds(15));
}
    }
