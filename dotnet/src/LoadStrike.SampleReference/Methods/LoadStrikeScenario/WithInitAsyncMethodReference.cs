using System;
    ...
    /// <summary>Attach an asynchronous init hook.</summary>
    public static class WithInitAsyncMethodReference
    {
...
{
    return baselineScenario().WithInitAsync(context => Task.CompletedTask);
}
