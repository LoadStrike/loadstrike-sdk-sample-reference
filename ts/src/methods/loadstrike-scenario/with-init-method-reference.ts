...
export class WithInitMethodReference {
  ...
  static async AttachMetricAwareHookExample(): Promise<unknown> {
      return baselineScenario().withInit(context => context.registerMetric(LoadStrikeMetric.counter("orders_seen", "count")));
  }
}
