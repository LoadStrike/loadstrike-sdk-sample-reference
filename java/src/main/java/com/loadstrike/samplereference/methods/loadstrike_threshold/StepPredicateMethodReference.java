package com.loadstrike.samplereference.methods.loadstrike_threshold;
      ...
      public final class StepPredicateMethodReference {
        private StepPredicateMethodReference() {}
...
public static Object CreateThresholdExample() {
    return LoadStrikeThreshold.stepPredicate("get-order", stats -> stats.okCount >= 1, 1, 2d);
}

/** Attach the threshold to the baseline GET scenario. */
public static Object AttachThresholdToScenarioExample() {
    return baselineScenario().withThresholds(LoadStrikeThreshold.stepPredicate("get-order", stats -> stats.okCount >= 1, 1, 2d));
}
      }
