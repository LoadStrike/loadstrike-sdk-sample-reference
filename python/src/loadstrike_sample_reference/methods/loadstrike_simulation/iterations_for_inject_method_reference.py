...
class IterationsForInjectMethodReference:
    @staticmethod
    def create_primary_simulation_example() -> Any:
        """Create the simulation shape named by this method reference."""
        return LoadStrikeSimulation.iterations_for_inject(2, 0.25, 5)

    @staticmethod
    def attach_simulation_to_scenario_example() -> Any:
        """Attach the simulation to the baseline GET scenario."""
        return baseline_scenario().with_load_simulations(LoadStrikeSimulation.iterations_for_inject(2, 0.25, 5))
