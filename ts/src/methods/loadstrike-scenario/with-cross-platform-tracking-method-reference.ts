...
export class WithCrossPlatformTrackingMethodReference {
  /** Attach the correlation configuration used for source and destination tracking. */
  static async AttachDelegateTrackingExample(): Promise<unknown> {
  ...
  static async AttachTrackingToEmptyScenarioExample(): Promise<unknown> {
