...
FEATURE_OVERVIEW = "This feature area focuses on report location, format, cadence, and logger customization without mixing in unrelated transport setup."
...
def build():
    ...
    context = _runner().build_context().with_report_formats(LoadStrikeReportFormat.Txt, LoadStrikeReportFormat.Html)
